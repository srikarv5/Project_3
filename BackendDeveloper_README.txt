...
========================================================\
\
Name of BackEndDeveloper: <Carter Lindstrom>\
@wisc.edu Email of BackEndDeveloper: <cjlindstrom@wisc.edu>\
Group: <BF>\
Team: <Purple>\
\
Files Written by Me:\
...
-------------------------\
< With our integration manager non responsive, I played a large part in\
 organizing communication between teammates, sharing code, and the overall\
